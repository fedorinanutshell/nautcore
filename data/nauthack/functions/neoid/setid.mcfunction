...
execute if entity @s[type = minecraft:player] run function nauthack:neoid/bind_player
execute if entity @s[type = !minecraft:marker, type = !minecraft:player] run function nauthack:neoid/bind
