...
scoreboard objectives add rmbcheck_check dummy {"text": "Active rmbcheck Villager", "color": "blue", "bold": true}
scoreboard objectives add rmbcheck_id dummy {"text": "rmbcheck ID", "color": "white", "bold": true}
