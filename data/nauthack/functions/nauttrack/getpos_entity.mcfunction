execute store result storage nauthack:nauthack nauttrack.coords.X double 1.0 run data get entity @s Pos[0] 1.0
execute store result storage nauthack:nauthack nauttrack.coords.Y double 1.0 run data get entity @s Pos[1] 1.0
execute store result storage nauthack:nauthack nauttrack.coords.Z double 1.0 run data get entity @s Pos[2] 1.0

execute as @e[limit=1, sort=nearest] store result score nauttrack_x1 nautmath_var run data get entity @s Pos[0] 1.0
execute as @e[limit=1, sort=nearest] store result score nauttrack_y1 nautmath_var run data get entity @s Pos[1] 1.0
execute as @e[limit=1, sort=nearest] store result score nauttrack_z1 nautmath_var run data get entity @s Pos[2] 1.0
...
data modify storage nauthack:nauthack nauttrack.dimension set from entity @s Dimension
data modify storage nauthack:nauthack nauttrack.isBlock set value false