...
execute at @s positioned ~ ~1.5 ~ positioned ^ ^ ^1 as @e[type = minecraft:armor_stand, tag = asyncray, distance = ..1.5] at @s anchored feet run function nauthack:asyncray/raytick