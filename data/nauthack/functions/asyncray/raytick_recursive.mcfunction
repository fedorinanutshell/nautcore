#recursive function executing unless asyncray_speed goes under 0
...
function #nauthack:asyncray/effects
function nauthack:asyncray/condition

execute if score asyncray_move nautmath_var matches 1 unless score asyncray_speed nautmath_var matches ..0 run tp @s ^ ^ ^0.25
